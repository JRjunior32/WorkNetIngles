...
class Publicaciones {
            ...
            $pub.=  '<div class="panel panel-default">
                     <div class="panel-body">
                       ...
                       <br><img src="../fotos/'.$Pub[$i]['Usuario_cuenta'].'/'.$Pub[$i]['ImgUsuario'].'" class="img-circle" id="img-pub">
                        ...
                        <button type="button" class="btn btn-default boton" id="" data-toggle="modal" data-target="#myModal"><span class="fui-cross"></span></i> Denounces</button>
                    <span class="badge" id="de">This publication has ' .$Pub[$i]['works'].' work(s) <i class="fa fa-suitcase"></i></span>
                    </div>
                    </div>';
                }
        return $pub;
    ...
    public function work($id){
        ...
        public function eliminarPub($id){
            ...
            if($result){
                $utilidades -> mostrarMensaje('The publication was successfully deleted!');
                    $tabla1='denuncias';
