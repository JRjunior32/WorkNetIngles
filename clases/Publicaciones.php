        ...
        for ($i = 0; $i < count($Pub); $i++) {
            $pub.=  '<blockquote class="public"><input type="hidden" value="'.$Pub[$i]['id'].'" name="idPub">
                       ...
                       <br><img src="../fotos/'.$Pub[$i]['Usuario_cuenta'].'/'.$Pub[$i]['ImgUsuario'].'" class="img-circle" id="img-pub">
                        ...
                        <button type="button" class="btn btn-default boton" id=""><span class="fui-cross"></span></i>Denuncia </button><span class="badge" id="de">This publication has ' .$Pub[$i]['works'].' work(s)</span>
                    </blockquote>';      
                }
        return $pub;
