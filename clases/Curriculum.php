...
class Curriculum {
    ...
    public function crearCurriculum($datos){
        ...
        if($result){
            $utilidades->mostrarMensaje("The résumé was successfully created!");
            ...
            $c.='<div class="panel panel-default">
                  <div class="panel-heading">'.$C[$i]['Nombre_Completo'].'</div>
                    <div class="panel-body">
                        <p>Phone Number: '.$C[$i]['Telefono'].'<br>Cellphone:'.$C[$i]['Celular'].'<br>
        ...
        for ($i = 0; $i < count($C); $i++){
            $c.='<div class="panel panel-default">
                  <div class="panel-heading">'.$C[$i]['Nombre_Completo'].'</div>
                    ...
                    <div class="panel-heading">Work Eperience</div>
                        <div class="panel-body">
                            <p>'.$C[$i]['Experiencia'].'</p>
                        </div>
                    <div class="panel-heading">References</div>
