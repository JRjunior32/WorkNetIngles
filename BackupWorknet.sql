...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2015 a las 23:15:16
...
ALTER TABLE `comentarios`
 ADD PRIMARY KEY (`idComentario`), ADD KEY `idPub` (`idPub`);
...
--
ALTER TABLE `comentarios`
ADD CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`idPub`) REFERENCES `publicaciones` (`idPub`) ON DELETE CASCADE;

--
-- Filtros para la tabla `curriculum`
--
ALTER TABLE `curriculum`
ADD CONSTRAINT `curriculum_ibfk_1` FOREIGN KEY (`idCuenta_cuenta`) REFERENCES `cuenta` (`idCuenta`) ON DELETE CASCADE;
