        ...
        <div class="login-form">
            ...
            <form action="../controladores/guardarEmpresa.php" method="POST">
                <div class='form-group'>     
                    ...
                    <input type='text' class='form-control login-field' id="letras" onkeypress="return numeros(event)" name='ape' placeholder='Surname' required /><br>
                    ...
                    <label for="FechaNacimiento"> Foundation Date (month/day/year):</label><br>
                    <input type='date' class='form-control login-field' name='birth' placeholder='Foundation Date' required /><br>
