        ...
        <div class="login-form">
            ...
            <form action="../controladores/guardarEmpresa.php" method="POST">
                <div class='form-group'>     
                    ...
                    <input type='password' id="repass" class='form-control login-field' name='repassword' placeholder='Comfirm Passwrod' required  /><br>
                    <div id="val"></div>
                    </div>
<<<<<<< HEAD
...
>>>>>>> origin/traduccionVistas
                    ...
                    <input type='email' id="remail" class='form-control login-field' name='remail' placeholder='Confirm email' required  /><br>
                    <div id="val2"></div>
                    </div>
                    ...
                    <a href='../controladores/index.php'><input type='button' value='Cancel' class='btn btn-primary btn-lg btn-danger'></a>
                    </p>
                </div>
            </form>
        </div>
