...
<a href="./mensajes.php" class="list-group-item"><i class="fa fa-users"></i> Seguidos</a>
<a href="../vistas/calendarioEmpresa.php" class="list-group-item"><span class="fui-calendar-solid"></span> Eventos</a>
<a href="" class="list-group-item" data-toggle="modal" data-target="#myModal"><span class="fui-calendar-solid"></span> Crear Eventos</a>
<a href="./logout.php" class="list-group-item"><span class="fui-power"></span> Cerrar Sesion</a>                  
                </div>
