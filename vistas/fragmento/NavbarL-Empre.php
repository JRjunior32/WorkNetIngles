...
<a href="../vistas/calendarioEmpresa.php" class="list-group-item"><span class="fui-calendar-solid"></span>Schedule</a>
<a href="./crearPortafolio.php" class="list-group-item"><span class="fui-clip"></span>Portfolio</a>
<a href="./formOfertas.php" class="list-group-item"><span class="fui-document"></span> Job Offers</a>
