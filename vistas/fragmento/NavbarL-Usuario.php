...
<a href="./formCurriculum.php" class="list-group-item"><i class="fa fa-file"></i> Create Curiculum</a>
<a href="./verCurriculum.php" class="list-group-item"><i class="fa fa-file"></i> Curiculum</a>
