            ...
            <ul class="nav navbar-nav">
                <form class="navbar-form navbar-left" role="search">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Busqueda por categoría">
                    </div>
                ...
                <li><a href="../controladores/perfil_Mostrar.php"><span class="fui-user"></span>Perfil</a></li>                
                <li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown"><span class="fui-gear"></span> Cuenta<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="../controladores/buscaramigos.php"><i class="fa fa-users"></i> Agregar amigos</a></li>
