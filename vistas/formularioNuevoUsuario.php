        ...
        <form action="../controladores/guardarUsuario.php" method="POST">
            <div class="login-form">
                <div class="from-group">
                    ...
                    Confirma correo:<input type="email" id="remail" class="form-control login-field" name="remail" placeholder="Confirmar correo" required /><br>
                    <div id="val2"></div>
                    </div>
                    <div class="from-group">
                    Fecha de nacimiento (dd/mm/aaaa):<input type="date" class="form-control login-field" name="birth" placeholder="Fecha de nacimiento" required /><br>
                    ...
                    <p class="text-center">
                        <input type="submit" name="Registrar" value="Registrarse" class="btn btn-primary btn-lg btn-warning" >
