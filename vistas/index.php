    ...
    <body class="fondi">
        <form action="../controladores/index.php" method="POST">
            ...
            <div class="login-form">                
                ...
                <p font-size="14pt">WorkNet es una red social para empresas, empresarios y trabajadores.</p>              
                ...
                <div id="divcen">
                    <center>
                        <input class="btn btn-primary btn-lg btn-danger" type="submit" value="Iniciar Sesión">
                        </div>
                <a class="login-link" href="php/olvido.php">¿Olvidó su contraseña?</a>

                </div><br>
                <div class="login-form">
                    <h4><center>Crear usuario como:</center></h4>
                    <div class="form-group">
                        <center>
