...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2015 a las 22:41:27
...
(3, 1, '2015-04-24', '2015-04-25', 'doc', 'hasdp'),
(4, 1, '2015-04-24', '2015-04-25', 'doc', 'hasdp');
...
--
ALTER TABLE `ofertas`
 ADD KEY `idCuenta` (`idCuenta`), ADD KEY `idOfertas` (`idOfertas`);
